...
const Profile: React.FC = () => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setMessage(
            t("failed_to_load_profile", "profile") ||
              "Failed to load profile data"
          );
        }
      } catch (err) {
        setMessage(
          t("server_connection_error", "profile") || "Server connection error"
        );
  ...
  const validateForm = () => {
    ...
    if (!formData.firstName.trim()) {
      errors.firstName =
        t("first_name_required", "profile") || "First name is required";
      isValid = false;
    }
    ...
    if (!formData.email.trim()) {
      ...
      errors.email =
        t("invalid_email_format", "profile") || "Invalid email format";
      isValid = false;
    }
    ...
    if (
      ...
      errors.mobileNumber =
        t("invalid_phone_format", "profile") || "Invalid phone number format";
      isValid = false;
    }
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setIsEditing(false);
        setMessage(
          t("profile_updated_successfully", "profile") ||
        ...
        setMessage(
          t("failed_to_update_profile", "profile") || "Failed to update profile"
        );
      }
    } catch (err) {
      setMessage(
  ...
  const validatePassword = () => {
    ...
    if (!passwordData.currentPassword) {
      errors.currentPassword =
        t("current_password_required", "profile") ||
    ...
    if (!passwordData.newPassword) {
      errors.newPassword =
        t("new_password_required", "profile") || "New password is required";
      isValid = false;
    } else {
      ...
      if (!hasUpperCase) {
        errors.newPassword =
          t("password_uppercase", "profile") ||
          "Password must include at least one uppercase letter";
        isValid = false;
      } else if (!hasLowerCase) {
        errors.newPassword =
          t("password_lowercase", "profile") ||
          "Password must include at least one lowercase letter";
        isValid = false;
      } else if (!hasNumbers) {
        errors.newPassword =
          t("password_number", "profile") ||
          "Password must include at least one number";
        isValid = false;
      } else if (!hasSpecialChar) {
        errors.newPassword =
          t("password_special", "profile") ||
          "Password must include at least one special character";
        isValid = false;
      } else if (!isLongEnough) {
        errors.newPassword =
          t("password_length", "profile") ||
    ...
    if (passwordData.newPassword !== passwordData.confirmPassword) {
      errors.confirmPassword =
        t("passwords_not_match", "profile") || "Passwords do not match";
      isValid = false;
    }
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(
          t("password_changed_successfully", "profile") ||
        ...
        setMessage(
          errorData.message ||
            t("current_password_incorrect", "profile") ||
        ...
        setMessage(
          t("failed_to_change_password", "profile") ||
  ...
  const passwordRequirements = (
    <div className="text-xs mt-1 text-muted">
      ...
      <ul className={`list-disc ${isRTL ? "list-right" : "list-inside"} mt-1`}>
        <li>
          {t("password_min_length", "profile") || "At least 8 characters"}
        </li>
      ...
      <div className="bg-bg-primary rounded-lg shadow-md p-6 mb-6">
        ...
        >
          <h2 className="text-xl font-semibold text-[var(--color-primary)]">
            {t("personal_information", "profile")}
          </h2>
          {!isEditing ? (
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            {isEditing ? (
              <>
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary ${
                    formErrors.firstName ? "border-red-500" : "border-light"
                  }`}
                  disabled={isLoading}
                />
              ...
              <p className="px-3 py-2 bg-bg-secondary rounded border-light">
                {formData.firstName || t("not_specified", "profile")}
              </p>
            )}
          </div>
            ...
            {isEditing ? (
              <>
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary ${
                    formErrors.lastName ? "border-red-500" : "border-light"
                  }`}
                  disabled={isLoading}
                />
                {formErrors.lastName && (
              ...
              <p className="px-3 py-2 bg-bg-secondary rounded border-light">
                {formData.lastName || t("not_specified", "profile")}
              </p>
            )}
          </div>
            ...
            {isEditing ? (
              <>
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary ${
                    formErrors.email ? "border-red-500" : "border-light"
                  }`}
                  disabled={isLoading}
                />
                {formErrors.email && (
              ...
              <p className="px-3 py-2 bg-bg-secondary rounded border-light">
                {formData.email || t("not_specified", "profile")}
              </p>
            )}
          </div>
            ...
            {isEditing ? (
              <>
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-primary ${
                    formErrors.mobileNumber ? "border-red-500" : "border-light"
                  }`}
                  disabled={isLoading}
                />
              ...
              <p className="px-3 py-2 bg-bg-secondary rounded border-light">
                {formData.mobileNumber || t("not_provided", "profile")}
              </p>
            )}
          </div>
        </div>
